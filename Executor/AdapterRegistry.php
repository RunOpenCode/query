 ...
 *
 * @phpstan-type GenericAdapter = AdapterInterface<TransactionInterface, OptionsInterface, ResultInterface>
 *
 * @internal
 */
...
{
    /**
     * @var array<non-empty-string, GenericAdapter>
     */
    private array $registry;

    /**
     * @param iterable<non-empty-string, GenericAdapter> $executors
     */
